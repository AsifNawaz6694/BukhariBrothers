                     ...
                     <div class="row portfolio-items-wrapper">
                        <div class="mix col-md-4 design">
                           <div class="portfolio-block">
                              <img class="img-responsive" src="{{asset('public/frontend_assets/images/portfolio/portfolio-1.jpg')}}" alt="">
                              <div class="caption">
                        ...
                        <div class="mix col-md-4 design">
                           <div class="portfolio-block">
                              <img class="img-responsive" src="{{asset('public/frontend_assets/images/portfolio/portfolio-2.jpg')}}" alt="">
                              <div class="caption">
                        ...
                        <div class="mix col-md-4 design development">
                           <div class="portfolio-block">
                              <img class="img-responsive" src="{{asset('public/frontend_assets/images/portfolio/portfolio-3.jpg')}}" alt="">
                              <div class="caption">
                        ...
                        <div class="mix col-md-4 photography development">
                           <div class="portfolio-block">
                              <img class="img-responsive" src="{{asset('public/frontend_assets/images/portfolio/portfolio-4.jpg')}}" alt="">
                              <div class="caption">
                        ...
                        <div class="mix col-md-4 design">
                           <div class="portfolio-block">
                              <img class="img-responsive" src="{{asset('public/frontend_assets/images/portfolio/portfolio-5.jpg')}}" alt="">
                              <div class="caption">
                        ...
                        <div class="mix col-md-4 photography" >
                           <div class="portfolio-block">
                              <img class="img-responsive" src="{{asset('public/frontend_assets/images/portfolio/portfolio-6.jpg')}}" alt="">
                              <div class="caption">
                        ...
                        <div class="mix col-md-4 design">
                           <div class="portfolio-block">
                              <img class="img-responsive" src="{{asset('public/frontend_assets/images/portfolio/portfolio-7.jpg')}}" alt="">
                              <div class="caption">
                        ...
                        <div class="mix col-md-4 design">
                           <div class="portfolio-block">
                              <img class="img-responsive" src="{{asset('public/frontend_assets/images/portfolio/portfolio-8.jpg')}}" alt="">
                              <div class="caption">
